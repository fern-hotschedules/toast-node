...
export declare namespace VoidReasons {
    interface Options {
...
export class VoidReasons {
    constructor(private readonly options: VoidReasons.Options) {}
    ...
    public async get(
        guid: string,
        request: HotschedulesToast.config.VoidSaleReasonRequest
    ): Promise<HotschedulesToast.config.VoidReason> {
        ...
        if (_response.ok) {
            return await serializers.config.VoidReason.parseOrThrow(
                _response.body as serializers.config.VoidReason.Raw,
     ...
     */
    public async getAll(
        request: HotschedulesToast.config.VoidSaleReasonsRequest
    ): Promise<HotschedulesToast.config.VoidReason[]> {
        ...
        if (_response.ok) {
            return await serializers.config.voidReasons.getAll.Response.parseOrThrow(
                _response.body as serializers.config.voidReasons.getAll.Response.Raw,
                { allowUnknownKeys: true }
            );
        }
