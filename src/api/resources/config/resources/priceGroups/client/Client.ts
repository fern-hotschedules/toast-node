...
export declare namespace PriceGroups {
    interface Options {
...
export class PriceGroups {
    constructor(private readonly options: PriceGroups.Options) {}
    ...
    public async get(
        guid: string,
        request: HotschedulesToast.config.PriceLevelForMenuItemsRequest
    ): Promise<HotschedulesToast.config.PriceGroup> {
        ...
        if (_response.ok) {
            return await serializers.config.PriceGroup.parseOrThrow(
                _response.body as serializers.config.PriceGroup.Raw,
     ...
     */
    public async getAll(
        request: HotschedulesToast.config.PriceLevelsForMenuItemsRequest
    ): Promise<HotschedulesToast.config.PriceGroup[]> {
        ...
        if (_response.ok) {
            return await serializers.config.priceGroups.getAll.Response.parseOrThrow(
                _response.body as serializers.config.priceGroups.getAll.Response.Raw,
                { allowUnknownKeys: true }
            );
        }
