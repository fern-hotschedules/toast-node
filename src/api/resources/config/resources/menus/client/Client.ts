...
export class Menus {
    ...
    public async get(
        guid: string,
        request: HotschedulesToast.config.MenuRequest
    ): Promise<HotschedulesToast.config.Menu> {
        ...
        if (_response.ok) {
            return await serializers.config.Menu.parseOrThrow(_response.body as serializers.config.Menu.Raw, {
     ...
     *
     */
    public async getAll(request: HotschedulesToast.config.MenusRequest): Promise<HotschedulesToast.config.Menu[]> {
        ...
        if (_response.ok) {
            return await serializers.config.menus.getAll.Response.parseOrThrow(
                _response.body as serializers.config.menus.getAll.Response.Raw,
                { allowUnknownKeys: true }
            );
        }
